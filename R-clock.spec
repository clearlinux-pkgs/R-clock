...
Version  : 0.7.3
Release  : 11
URL      : https://ftp.osuosl.org/pub/cran/src/contrib/clock_0.7.3.tar.gz
Source0  : https://ftp.osuosl.org/pub/cran/src/contrib/clock_0.7.3.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742849380
